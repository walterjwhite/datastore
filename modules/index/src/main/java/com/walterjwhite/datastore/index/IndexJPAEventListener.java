...
@EventListener
public class IndexJPAEventListener {
  private static final Logger LOGGER = LoggerFactory.getLogger(IndexJPAEventListener.class);
  ...
  @Inject
  public IndexJPAEventListener(
      IndexService indexService, EntityTypeRepository entityTypeRepository) {
    super();
